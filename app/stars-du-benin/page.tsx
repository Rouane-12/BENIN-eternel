  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="flex items-center justify-center rounded-full font-display text-white shrink-0 mx-auto mb-3 ring-2"
          style={{
            width: meta.avatar,
            height: meta.avatar,
        ...
        <p className={`text-white/55 leading-relaxed text-center ${first ? "text-[12.5px] line-clamp-3" : "text-[11px] line-clamp-2"}`}>
          {influenceur.bio}
        </p>
      </motion.div>
